...
@Component({
  ...
  scroll(el: HTMLElement) {
    ...
    //Pour chaque question grammaire on remplie le form objet
  ...
  submit() {
    ...
    //parcoure les questions grammaire et regarde si reponsesUser est égale a bonneReponses
    for (var y = 0; y < this.questions2.length; y++) {
      if (this.questions2[y].reponsesUser == this.questions2[y].bonneReponses)
      acc_good_answer2++;
    }
    //nombre de questions dans QuestionsGrammaire
    var QuestionsGrammaire = this.questions.length;
    //nombre de questions dans QuestionsVocab
    ...
    //nombre de bonne réponses total 
    var acc_good_answer3 = acc_good_answer2 + acc_good_answer;
      Email.send({
        ...
        Body:
          ...
          "Score total: " + acc_good_answer3 + " bonne réponses / " + QuestionsTotal + " questions <br>" + "Grammaire :<br>" +

          this.createBodyAnswer() + "Vocabulaire :<br>" +
          this.createBodyAnswerVocab()
    ...
    const dialogRef = this.dialog.open(PopupComponent, {
      ...
      data: { acc_good_answer: acc_good_answer, acc_good_answer2: acc_good_answer2, QuestionsVocab: QuestionsVocab, QuestionsGrammaire: QuestionsGrammaire, name: this.name },
    });
  ...
  createBodyAnswerVocab(){

    var bodyAnswerVocab = '<br><ul>'

    for (var i = 0; i < this.questions2.length; i++) {
      var isGoodAnswer = this.questions2[i].reponsesUser == this.questions2[i].bonneReponses;
      var color = isGoodAnswer ? "#0e5504" : "#FF0000";


      bodyAnswerVocab += '<li style="color:' + color + ' ">' + this.questions2[i].nom2 + " " + this.questions2[i].Vocab + " a répondu : " + this.questions2[i].reponses[this.questions2[i].reponsesUser] + ', la bonne réponse était : ' + this.questions2[i].reponses[this.questions2[i].bonneReponses]+ '</li><br>'


    }

    bodyAnswerVocab += '</ul><br>'
    return bodyAnswerVocab;
  }
